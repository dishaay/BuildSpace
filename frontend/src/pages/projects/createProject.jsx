  ...
  return (
    <AppShell>
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="font-display font-semibold text-2xl mb-1">Submit a project</h1>
          <p className="text-ink-muted text-sm">
            Show the community what you're building — and flag it if you're looking for collaborators.
          </p>
        </div>
